              ...
              <Flex align='center' className='p-4' style={{ gap: '12px', paddingTop: '24px' }}>
                ...
                {isFlightPlannerMode ? (
                  <Flex
                    align='center'
                    gap='2'
                    style={{ width: '350px', flexShrink: 0, overflow: 'hidden', position: 'relative' }}
                  >
                    <Text
                      size='1'
                      weight='medium'
                  ...
                  >
                    ...
                    <Badge size='1' color={getStatusColor(missionStatus)}>
                      {missionStatus}
                    </Badge>
                    {!missionLaunched && (
                      <>
                        ...
                        {nodeTab === 'overview' ? (
                          <>
                            ...
                            <Button
                              ...
                              variant='soft'
                              color='orange'
                              disabled={!missionConfig.routes}
                              onClick={() => updateMissionConfig({ routes: undefined })}
                            >
                              <RouteOff size={14} /> Clear Route Plan
                            </Button>
                            <AlertDialog.Root>
                              <AlertDialog.Trigger>
                    ...
                    <Box style={{ opacity: isConfigLocked ? 0.5 : 1, pointerEvents: isConfigLocked ? 'none' : 'auto' }}>
                      ...
                      >
                        ...
                        <Select.Content>
                          ...
                          <Select.Item value='fstsp'>Greedy</Select.Item>
                        </Select.Content>
                      </Select.Root>
                    </Box>
                  </Box>
                        ...
                        {orderNodes.map(order => {
                          ...
                          return (
                            ...
                            >
                              <Flex>
                                <div
                                  style={{ width: '4px', minHeight: '100%', backgroundColor: accentColor, flexShrink: 0 }}
                                />
                                <Box style={{ padding: '10px 12px', flex: 1 }}>
                                  <Flex justify='between' align='center' style={{ marginBottom: '6px' }}>
                                    <Flex align='center' gap='2'>
                                      <MapPin
                                        size={14}
                                        style={{ color: accentColor === '#d1d5db' ? '#9ca3af' : accentColor }}
                                      />
                                      <Text size='2' weight='bold'>
                        ...
                        {missionSites.map(node => {
                          ...
                          return (
                            ...
                            >
                              <Flex>
                                <div
                                  style={{ width: '4px', minHeight: '100%', backgroundColor: nodeColor, flexShrink: 0 }}
                                />
                                <Box style={{ padding: '10px 12px', flex: 1 }}>
                                  <Flex justify='between' align='start' style={{ marginBottom: '4px' }}>
                                    <Flex align='center' gap='1'>
                                      ...
                                      <Box>
                                        ...
                                        <Text
                                          size='1'
                                          style={{ color: nodeColor, fontWeight: 500, display: 'block', marginTop: '-1px' }}
                                        >
